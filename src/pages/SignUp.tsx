          ...
          <div className="flex-col px-7 py-5 border-2 border-gray-300 rounded-lg shadow-lg shadow-gray-500">
            ...
            <div className="py-4">
              <div className="text-center text-sm font-light text-gray-600">
                ...
                <Link to="/login" className="px-1.5 text-blue-600 font-light">
                  Sign in
                </Link>
              </div>
            </div>
            ...
            <div className="w-full">
              ...
              <div className="text-center text-sm font-light text-gray-600">
                ...
                <Link
                  //to={{ pathname: "/legal", hash: "#terms" }}
                  to="/legal/#terms"
                  className="px-1.5 text-blue-600 font-light"
                >
                  Terms of Service
                </Link>
                and
                <Link
                  //to={{ pathname: "/legal", hash: "#privacy" }}
                  to="/legal/#privacy"
                  className="px-1.5 text-blue-600 font-light"
                >
                  Privacy Policy
